...
abstract class Core {
  const
    version = '1.3.11'; # Current release number
  ...
  static function containsShortcode($content, $shortcode){
    return (StrPos($content, "[{$shortcode}]") !== False) || (StrPos($content, "[{$shortcode} ") !== False);
  }
