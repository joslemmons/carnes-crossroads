...
class iMapListing extends \TimberPost {
    ...
    {
        self::$_postType = Config::getKeyPrefix() . 'imap_listing';
        self::$_title = 'iMap Listing';
        self::$_taxonomy = 'imap_listing_type';
    ...
    public function getCategory() {
        $categories = $this->get_terms('imap_listing_type');
        $cat = end($categories);
        return $cat->slug;
    }
}